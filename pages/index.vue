  ...
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20 text-balance">
    ...
    <div class="text-center sm:text-left">
      ...
      <ul class="space-y-3 sm:space-y-4 font-bold text-slate-500 text-[11px] uppercase tracking-widest">
        <li><NuxtLink to="/oficios/pintores" class="hover:text-black">Pintores</NuxtLink></li>
        <li><NuxtLink to="/oficios/electricistas" class="hover:text-black">Electricistas</NuxtLink></li>
        <li><NuxtLink to="/oficios/fontaneros" class="hover:text-black">Fontaneros</NuxtLink></li>
        <li><NuxtLink to="/oficios/reformas-integrales" class="hover:text-black">Reformas</NuxtLink></li>
        <li><NuxtLink to="/oficios/limpieza" class="hover:text-black">Limpieza</NuxtLink></li>
        <li><NuxtLink to="/oficios/carpinteros" class="hover:text-black">Carpinteros</NuxtLink></li>
        <li><NuxtLink to="/oficios/climatizacion" class="hover:text-black">Climatización</NuxtLink></li>
      </ul>
    </div>
    ...
    <div class="text-center sm:text-left">
      ...
      <ul class="space-y-3 sm:space-y-4 font-bold text-slate-500 text-[11px] uppercase tracking-widest">
        <li><NuxtLink to="/oficios/albaniles" class="hover:text-black">Albañiles</NuxtLink></li>
        <li><NuxtLink to="/oficios/jardineros" class="hover:text-black">Jardineros</NuxtLink></li>
        <li><NuxtLink to="/oficios/pladuristas" class="hover:text-black">Pladuristas</NuxtLink></li>
        <li><NuxtLink to="/oficios/cerrajeros" class="hover:text-black">Cerrajeros</NuxtLink></li>
        <li><NuxtLink to="/oficios/montadores-muebles" class="hover:text-black">Montadores</NuxtLink></li>
        <li><NuxtLink to="/oficios/tecnicos-electrodomesticos" class="hover:text-black">Reparaciones</NuxtLink></li>
      </ul>
    </div>
